	...
	if(productItemValue == '01'){
		if(productItemDisplayValue == '21' || productItemDisplayValue == '31'){
			if(isEmpty(corJkBodylengthCorrectAgain) && isEmpty(corJkWaistCorrectAgain) && isEmpty(corJkRightsleeveCorrectAgain) &&　isEmpty(corJkLeftsleeveCorrectAgain)
				...
				jQuery('#jkCorrectAgain').hide();
				jQuery('#ptCorrectAgain').hide();
				jQuery('#correctionMemoAgain').hide();
			}else{
...
jQuery("#saveValue").click(function(){
	...
	if(oldShippingDate != "" && shippingDate == "Invalid Date"){
		...
		swal({						
			  ...
			  if (isConfirm) {			
				  swal({		
					  text: getMsgByOneArg('msg115', dateFormatValue(shippingDate)),	
					  icon: "info",	
					  buttons: ["キャンセル", true],	
					  dangerMode: true,	
					  closeOnEsc: false,	
					  ...
					  if (isConfirm) {
						  swal({		
							  text: getMsgByOneArg('msg116', dateFormatValue(loadingDate)),	
							  icon: "info",	
							  buttons: ["キャンセル", true],	
							  dangerMode: true,	
							  closeOnEsc: false,	
