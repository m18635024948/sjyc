...
public class CoOptionJacketStandardInfo implements Serializable {
	...
	//ラペルモデル
    private String ojJacketLapelModel;
...
//    private String ojAllByColor;
	...
	//肩パット
	private Map<String, String> corJkShoulderPadMap;
	
	//体型補正
	private Map<String, String> corJkFigureCorrectMap;
	
	//刺繍糸色
	private Map<String, String> jkProductEmbroideryThreadColorMap;
	
	public Map<String, String> getCorJkShoulderPadMap() {
		return corJkShoulderPadMap;
	}

	public void setCorJkShoulderPadMap(Map<String, String> corJkShoulderPadMap) {
		this.corJkShoulderPadMap = corJkShoulderPadMap;
	}

	public Map<String, String> getCorJkFigureCorrectMap() {
		return corJkFigureCorrectMap;
	}

	public void setCorJkFigureCorrectMap(Map<String, String> corJkFigureCorrectMap) {
		this.corJkFigureCorrectMap = corJkFigureCorrectMap;
	}

	public Map<String, String> getJkProductEmbroideryThreadColorMap() {
		return jkProductEmbroideryThreadColorMap;
	}

	public void setJkProductEmbroideryThreadColorMap(Map<String, String> jkProductEmbroideryThreadColorMap) {
		this.jkProductEmbroideryThreadColorMap = jkProductEmbroideryThreadColorMap;
	}
	...
	public String getOjJacketLapelModel() {
		return ojJacketLapelModel;
	}

	public void setOjJacketLapelModel(String ojJacketLapelModel) {
		this.ojJacketLapelModel = ojJacketLapelModel;
	}

	public String getOjBhAllColor() {
		return ojBhAllColor;
	}

	public void setOjBhAllColor(String ojBhAllColor) {
		this.ojBhAllColor = ojBhAllColor;
	}

	public String getOjByAllColor() {
		return ojByAllColor;
	}

	public void setOjByAllColor(String ojByAllColor) {
		this.ojByAllColor = ojByAllColor;
	}
}
